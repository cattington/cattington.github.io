...
const MusicInfo = [
    ...
    {id:3,
        ...
        role:"Principle Tenor Saxophonist",
        caption:"Trinity School's Highest Level Jazz Ensemble",
        songs:["Spain, Chick Corea","Colors, Black Pumas","Take the A Train, Duke Ellington","Josie, Steely Dan","Tenor Madness, Sonny Rollins","Cut the Cake, Average White Band","The Chicken, Jaco Pastorius"],
        gigs:"2023 Spain & France Tour, Trinity Evening of Jazz and Music",
        vid:"./assets/messengers.mp4",
        cover:"./assets/messengers.jpg"
